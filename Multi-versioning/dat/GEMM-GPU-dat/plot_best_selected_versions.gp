...
plot "data_v10" using 1:($2 / ($1 * $1 + $1 * $1 * $1)) with linespoints title "tile-size = 8x8x8, block-size = 8x8, v10",\
     ...
     "data_v14" using 1:($2 / ($1 * $1 + $1 * $1 * $1)) with linespoints title "tile-size = 128x128x128, block-size = 8x8, v14",\
     "data_v15" using 1:($2 / ($1 * $1 + $1 * $1 * $1)) with linespoints title "tile-size = 16x16x16, block-size = 16x16, v15",\
     "data_v16" using 1:($2 / ($1 * $1 + $1 * $1 * $1)) with linespoints title "tile-size = 32x32x32, block-size = 16x16, v16",\
     "data_v17" using 1:($2 / ($1 * $1 + $1 * $1 * $1)) with linespoints title "tile-size = 64x64x64, block-size = 16x16, v17",\
     "data_v18" using 1:($2 / ($1 * $1 + $1 * $1 * $1)) with linespoints title "tile-size = 128x128x128, block-size = 16x16, v18",\
