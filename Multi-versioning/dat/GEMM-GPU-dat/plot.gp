...
plot 'aux_output' using 1:2 with filledcurves y = 1 lc "dark-khaki" fs transparent solid 0.2 notitle,\
     ...
     'aux_output' using 1:13 with filledcurves y = 1 lc "gold" fs transparent solid 0.2 notitle,\
     ...
     "data_v21.dat.log10" using 1:2 with linespoints pt 12 lc "gold" title "tile-size = 128x128x128, block-size = 32x32, v21",\
